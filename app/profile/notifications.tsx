  ...
  const renderToggle = (
    ...
    <View className="flex-row items-center px-6 py-5 bg-white mb-0.5">
      ...
      <View className="flex-1 mr-4">
        ...
        <Text className="text-xs text-[#8E9BAE] mt-0.5 leading-4">
          {sublabel}
        </Text>
      </View>
      <Switch
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="p-10">
          <Text className="text-center text-[#CBD5E0] text-[11px] font-medium leading-4">
            You can change these settings at any time. Changes might take a few
            minutes to reflect across all platforms.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
